# SO CMS Load More / Load Less for Webflow
...
This library is designed to be plug-and-play for Webflow developers. It automatically handles multiple pages of CMS items and provides a smooth user experience.
...
Include the script in your Webflow project by pasting the following **Inside the body**:
    ...
    <script src="https://cdn.jsdelivr.net/gh/tirthesh31/cmsload@main/so-cmsload-v1.min.js" defer></script>
...
Give your Previous button a custom attribute:
